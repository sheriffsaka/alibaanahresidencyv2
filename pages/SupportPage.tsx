  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      <div className="text-center mb-12">
        <IconBuilding className="w-16 h-16 text-brand-500 mx-auto mb-4" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* FAQ Link */}
        <div className="bg-brand-50 dark:bg-brand-900/20 p-8 rounded-2xl shadow-lg border border-brand-100 dark:border-brand-900/30 flex flex-col justify-center items-center text-center">
          <h2 className="text-2xl font-bold mb-3 text-brand-800 dark:text-brand-200">{t.visitFAQ}</h2>
          <p className="text-brand-700 dark:text-brand-300 mb-6">{t.visitFAQDescription}</p>
          <button 
            onClick={() => setPage('home')}
            className="bg-brand-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-brand-700 transition-all shadow-md"
          >
            Go to FAQ
          </button>
        </div>
